        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div class="col-md-7">
              <div class="row mb-5">
                <div class="col-12 ">
                  <h2 class="site-section-heading text-center">Filter Results</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Emfanizei ta apotelesmata toy filtrarismatos -->
          <div class="row" id="lightgallery">
            <?php
              ...
              $sql = "SELECT * FROM paintings JOIN tags ON paintings.painting_id = tags.painting_id WHERE tags.tag = '" . $tag . "'";
              ...
              if($result = mysqli_query($conn, $sql))
              {
                ...
                if($num_results > 0){
                  ...
                  echo ""
            ?>
                  <h3 class="container-fluid text-center">No results found</h2>
            <?php  
                }
              }
            ?>
